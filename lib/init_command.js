...
module.exports = class Command {
  constructor() {
    this.name = 'egg-init';
    this.configName = 'flclover-init-config';
  ...
  * downloadBoilerplate(pkgName) {
    ...
    const saveDir = path.join(os.tmpdir(), 'flclover-init-boilerplate');
  ...
  * getPackageInfo(pkgName, withFallback) {
    ...
    try {
      // https://r.cnpmjs.org/egg-boilerplate-simple/download/egg-boilerplate-simple-2.5.0.tgz
